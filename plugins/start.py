...
async def not_joined(client: Client, message: Message):
    text = "<b>🔊 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 🤭.\n\nനിങ്ങൾക്ക് മൂവീസ് വേണോ❓ \n\nഎങ്കിൽ തായെ കാണുന്ന ഞങ്ങളുടെ മെയിൻ ചാനലിൽ ജോയിൻ ചെയ്യുക💥.\n\nഎന്നിട്ട് താഴെ കാണുന്ന try again ക്ലിക്ക് ചെയ്യുക..❗😁</b>"
    ...
    try:
        ...
        pass
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("♨️Join our Channel♨️", url = client.invitelink)]])
    await message.reply(
        text = text,
        reply_markup = reply_markup,
        quote = True,
